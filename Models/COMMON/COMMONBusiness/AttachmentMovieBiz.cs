...
{
    public class AttachmentMovieBiz : AttachmentFileBiz
    {
        #region Private Data
        #endregion
        #region Constructors
        public AttachmentMovieBiz()
            : base()
        {

        }
        public AttachmentMovieBiz(int intID)
            : base(intID)
        {
            ...
            get
            {
                ...
                if (Name != null && Name != "")
                {
                    ...
                    if (!File.Exists(Returned))
                    {
                        ...
                        FileStream objFs = new FileStream(Returned, FileMode.Create, FileAccess.Write);
