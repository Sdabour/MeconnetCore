...
namespace SharpVision.COMMON.COMMONBusiness
{
    public class CountryCol : CollectionBase
    {
        ...
        static CountryCol _CacheCountryCol;
        public static CountryCol CacheCountryCol
        {
            get
            {
                if (_CacheCountryCol == null)
                {
                    _CacheCountryCol = new CountryCol(false);
                }
                return _CacheCountryCol;
