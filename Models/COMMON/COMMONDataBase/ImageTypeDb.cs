...
namespace SharpVision.COMMON.COMMONDataBase
{
    public class ImageTypeDb : BaseSingleDb
    {
        ...
        public string AddStr
        {
            get
            {
                string Returned = " INSERT INTO COMMONImageType" +
        ...
        public string EditStr
        {
            get
            {
                string Returned = " UPDATE    COMMONImageType" +
        ...
        public string AddIdentityStr
        {
            get
            {
                string Returned = "INSERT INTO COMMONImageType (ImageTypeID) " +
                     " SELECT       " + _ID + " AS ImageTypeID1 " +
                     " WHERE        (NOT EXISTS " +
                     " (SELECT        ImageTypeID " +
                     " FROM            COMMONImageType  " +
                     " WHERE        (ImageTypeID = " + _ID + "))) ";
                Returned += " " + EditStr;
                return Returned;
            }
