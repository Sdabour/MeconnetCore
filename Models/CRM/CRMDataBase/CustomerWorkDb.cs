...
namespace SharpVision.CRM.CRMDataBase
{
    public class CustomerWorkDb
    {
        ...
        #endregion
        #region Constructors
        public CustomerWorkDb()
        {

        }
        public CustomerWorkDb(DataRow objDr)
        {
            SetData(objDr);
        }
        public CustomerWorkDb(int intCustomerID)
        {
            if (intCustomerID == 0)
                return;
        ...
        public string AddStr
        {
            get
            {
                string strReturn = " Insert into CRMCustomerWork (Customer,Country,City,District,Region,OtherValue)"+
        ...
        public string EditStr
        {
            get
            {
                string strReturn = " Update CRMCustomerWork " +
        ...
        public string DeleteStr
        {
            get
            {
                string strReturn = "Delete From CRMCustomerWork Where Customer = " + _Customer + "";
                return strReturn;
            }
        }
