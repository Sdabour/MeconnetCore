...
{
    public class ReservationSalesSumDb
    {
#region Private Data
        ...
        #region Constractors
        public ReservationSalesSumDb()
        {
            
        }
        public ReservationSalesSumDb(DataRow objDR)
        {
            SetData(objDR);
        }
        #endregion
        ...
        public string SearchStr
        {
            get
            {
                ...
                //string strInstallment = "SELECT dbo.CRMReservation.ReservationID, SUM(dbo.CRMReservationInstallment.InstallmentValue) AS TotalInstallmentValue "+
                //      " FROM     dbo.CRMReservation INNER JOIN "+
                //      " dbo.CRMReservationInstallment ON dbo.CRMReservation.ReservationID = dbo.CRMReservationInstallment.ReservationID "+
                ...
                string strReservation = "select CRMReservation.ReservationStatus,CRMReservation.ReservationDate,CRMReservation.ReservationContractingDate,InstallmentTable.ReservationID,InstallmentTable.TotalInstallmentValue+" +
                    " TempPaymentTable.TempPaymentValue - DiscountTable.TotalDiscount as ReservationValue "+
